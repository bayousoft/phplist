...
<ul>
<li><b>HTML</b> - HTML to users who have indicated that they want to receive their emails in HTML format, and text to everyone else</li>
<li><b>text</b> - text-only to everyone</li>
<li><b>text and HTML</b> - One big email that contains both the HTML and the text only format (larger emails, but more likely to work for most users)</li>
