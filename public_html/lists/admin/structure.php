...
if (!defined('STRUCTUREVERSION')) {
  ...
  $DBstructphplist = array( # order of tables is essential for smooth upgrade
...
#          "index_2" => array("emailnameidx (email,name)",""), ## @@@ index too big??
      ...
      "list" => array ( # a list in the system
          ...
          "rssfeed" => array("varchar(255)","Rss Feed"),                  //Leftover from the preplugin era
  ...
  #        "status" => array("enum('submitted','inprocess','sent','cancelled','prepared','draft')","Status"),
        ...
        "astextandhtml" => array("integer default 0","Sent as Text and HTML"), // obsolete
          ...
          "rsstemplate" => array("varchar(100)","if used as a RSS template, what frequency"),                              //Leftover from the preplugin era
      ...
      #rss tables moved to rssmanager plugin
