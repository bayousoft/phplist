...
<li><?php echo PageLink2("import1","Import emails with the same values for attributes");?>. The list of emails will have to comply with the structure you have already set up in <?=NAME?>. You should use this option if you are importing a simple list of emails. You can then specify the values for the attributes for each entry. They will be the same for everyone you are importing.<br/><br/>
