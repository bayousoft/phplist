...
<ul>
<li><?php echo PageLink2("import2","Importa le email con differenti valori per gli attributi");?>. Nell'elenco di email sono ammessi attributi non ancora definiti. Questi saranno creati automaticamente come attributi di testo. Dovresti usare questa opzione se stai importando un elenco da un foglio di calcolo/file CSV che ha attributi per gli utenti nelle colonne e un utente per linea. <br/><br/>
