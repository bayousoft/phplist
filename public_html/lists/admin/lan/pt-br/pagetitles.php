...
switch ($page) {
  ...
  case 'setup': $page_title = 'Op&ccedil&otildees de Configura&ccedil&atilde;o';break;
  ...
  case 'checki18n': $page_title = 'Verificar se essas tradu&ccedil&otildees existem';break;
  ...
  case 'userhistory': $page_title = 'Hist&oacuterico de um usu&aacute;rio';break;
  ...
  case 'defaults': $page_title = 'Alguns atributos padr&atilde;o &uacuteteis';break;
  ...
  case 'spage': $page_title = 'p&acuteginas de Inscri&ccedil&atilde;o';break;
  case 'eventlog': $page_title = 'Relat&oacuterio de eventos';break;
  ...
  case 'mclicks': $page_title = 'Estat&iacutesticas de Clique em Mensagens'; break;
  case 'uclicks': $page_title = 'Estat&iacutesticas de Clique em URL'; break;
}
?>
