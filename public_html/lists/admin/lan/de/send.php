...
$lan = array (
  ...
  'repeatevery' => 'Nachricht wiederholen alle',
  ...
  'text' => 'Text',
  'pdf' => 'PDF',
  'textandhtml' => 'Text und HTML',
  'textandpdf' => 'Text und PDF',
  'usetemplate' => 'Template benutzen',
  'selectone' => 'W&auml;hlen Sie',
  'rssintro' => 'Falls Sie diese Nachricht als Template f&uuml;r den Versand von RSS Feeds benutzen wollen,
    w&auml;hlen Sie die H&auml;ufigkeit, mit der sie benutzt werden soll, und verwenden Sie [RSS] in Ihrer Nachricht um anzuzeigen, wo die Liste der Items eingef&uuml;gt werden soll.',
  'none' => 'Keine',
  ...
  'maxfileupload' => 'Maximale Dateigr�se (pro Datei)',
  ...
  'newattachment' => 'Neues Attachment',
  'addandsave' => 'Hinzuf&uuml;gen (und speichern)',
  'pathtofile' => 'Pfad zur Datei auf dem Server',
  'attachmentdescription' => 'Beschreibung des Attachments',
