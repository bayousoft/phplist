...
switch ($page) {
  ...
  case 'login': $page_title = 'collegati';break;
  case 'logout': $page_title = 'Scollegato';break;
  case 'mclicks': $page_title = 'Statistica dei Click sui messaggi'; break;
  case 'uclicks': $page_title = 'Statistica dei Click sugli URL'; break;
