...
$requiredVars = array(
	...
	"language_module"=> array(
		...
		"type"=> "scalar",
		"description"=> "Language module to use. Defualt english.",
		"values"=> "english.inc"),
	"database_host"=> array(
		"name"=> "database_host",
		"type"=> "scalar",
	...
	"database_name"=> array(
		"name"=> "database_name",
		"type"=> "scalar",
		"description"=> "Database name. Previous created, if not do it now, before continue.",
		"values"=> "phplistdb"),
	"database_user"=> array(
		"name"=> "database_user",
		"type"=> "scalar",
		"description"=> "Database user. Previous created, phplist cannot create one. Ask your host provider if you dont have one.",
		"values"=> "admin"),
	"database_password"=> array(
		"name"=> "database_password",
		"type"=> "scalar",
		"description"=> "Database password. Previous created with the user.",
		"values"=> "phplist"),
